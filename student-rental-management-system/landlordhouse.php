...
<html lang="en">
  ...
  <head>
    ...
    <section class="section" id="inserthouse">
        <div class="container">
            <br>
            <br>
            <article>
                ...
                <div class="testbox">
                    <form action="dbconnection.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="item">
                        <p>Monthly Rent</p>
                        <input type="Text" id="rent" name="rent" placeholder="RM 0.00">
                      </div>
                      <div class="item">
                        <p>Address</p>
                        <textarea rows="5" id="address" name="address" placeholder="House Address"></textarea>
                      </div>
                      <div class="item">
                        <p>Info</p>

...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2024 at 06:26 PM
...
CREATE TABLE `sign_agreements` (
  ...
  `startRental` varchar(255) NOT NULL,
  `endRental` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sign_agreements` (`agreement_id`, `application_id`, `startRental`, `endRental`) VALUES
(1, '22', '2024-01-26', '2024-01-15');
...
INSERT INTO `student_applications` (`application_id`, `house_id`, `student_name`, `student_email`, `student_phone`, `status`) VALUES
(22, 15, 'sddss', 'dsdsds', 'dsdssd', 'approved');
...
--
-- Indexes for table `sign_agreements`
--
ALTER TABLE `sign_agreements`
...
--
-- AUTO_INCREMENT for table `sign_agreements`
--
ALTER TABLE `sign_agreements`
  MODIFY `agreement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
